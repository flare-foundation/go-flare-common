...
CONTRACTS=(
  ...
  "tee/facets/ExtensionPausingFacet.sol/ExtensionPausingFacet.json"
  ...
  "tee/facets/ReplicationFacet.sol/ReplicationFacet.json"
  "tee/facets/ReplicationInit.sol/ReplicationInit.json"
  ...
  "tee/facets/WalletResumeFacet.sol/WalletResumeFacet.json"
...
STRUCTS=(
  ...
  "tee/structs/TeeReplicationStructs.sol/TeeReplicationStructs.json"
