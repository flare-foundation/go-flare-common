...
func (_TeeVRFVerifier *TeeVRFVerifierCaller) RandomnessFromProof(opts *bind.CallOpts, _gammaX *big.Int, _gammaY *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _TeeVRFVerifier.contract.Call(opts, &out, "randomnessFromProof", _gammaX, _gammaY)
...
//
// Solidity: function randomnessFromProof(uint256 _gammaX, uint256 _gammaY) pure returns(bytes32)
func (_TeeVRFVerifier *TeeVRFVerifierSession) RandomnessFromProof(_gammaX *big.Int, _gammaY *big.Int) ([32]byte, error) {
	return _TeeVRFVerifier.Contract.RandomnessFromProof(&_TeeVRFVerifier.CallOpts, _gammaX, _gammaY)
}

// RandomnessFromProof is a free data retrieval call binding the contract method 0x13a0c07c.
//
// Solidity: function randomnessFromProof(uint256 _gammaX, uint256 _gammaY) pure returns(bytes32)
func (_TeeVRFVerifier *TeeVRFVerifierCallerSession) RandomnessFromProof(_gammaX *big.Int, _gammaY *big.Int) ([32]byte, error) {
	return _TeeVRFVerifier.Contract.RandomnessFromProof(&_TeeVRFVerifier.CallOpts, _gammaX, _gammaY)
}
...
func (_TeeVRFVerifier *TeeVRFVerifierCaller) VerifyRandomness(opts *bind.CallOpts, _proof VrfVerifierProof, _pkX *big.Int, _pkY *big.Int, _nonce []byte) (bool, error) {
	var out []interface{}
	err := _TeeVRFVerifier.contract.Call(opts, &out, "verifyRandomness", _proof, _pkX, _pkY, _nonce)
...
//
// Solidity: function verifyRandomness(((uint256,uint256),uint256,uint256,(uint256,uint256),(uint256,uint256),(uint256,uint256),uint256) _proof, uint256 _pkX, uint256 _pkY, bytes _nonce) view returns(bool _valid)
func (_TeeVRFVerifier *TeeVRFVerifierSession) VerifyRandomness(_proof VrfVerifierProof, _pkX *big.Int, _pkY *big.Int, _nonce []byte) (bool, error) {
	return _TeeVRFVerifier.Contract.VerifyRandomness(&_TeeVRFVerifier.CallOpts, _proof, _pkX, _pkY, _nonce)
}

// VerifyRandomness is a free data retrieval call binding the contract method 0x1fc57fbd.
//
// Solidity: function verifyRandomness(((uint256,uint256),uint256,uint256,(uint256,uint256),(uint256,uint256),(uint256,uint256),uint256) _proof, uint256 _pkX, uint256 _pkY, bytes _nonce) view returns(bool _valid)
func (_TeeVRFVerifier *TeeVRFVerifierCallerSession) VerifyRandomness(_proof VrfVerifierProof, _pkX *big.Int, _pkY *big.Int, _nonce []byte) (bool, error) {
	return _TeeVRFVerifier.Contract.VerifyRandomness(&_TeeVRFVerifier.CallOpts, _proof, _pkX, _pkY, _nonce)
}
