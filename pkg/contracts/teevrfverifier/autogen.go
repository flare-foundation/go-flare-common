...
func (_TeeVRFVerifier *TeeVRFVerifierCaller) VerifyRandomness(opts *bind.CallOpts, _proof IVrfVerifierProof, _pkX *big.Int, _pkY *big.Int, _nonce []byte) (bool, error) {
	var out []interface{}
...
//
// Solidity: function verifyRandomness(((uint256,uint256),uint256,uint256,(uint256,uint256),(uint256,uint256),(uint256,uint256),uint256) _proof, uint256 _pkX, uint256 _pkY, bytes _nonce) view returns(bool _valid)
func (_TeeVRFVerifier *TeeVRFVerifierSession) VerifyRandomness(_proof IVrfVerifierProof, _pkX *big.Int, _pkY *big.Int, _nonce []byte) (bool, error) {
...
//
// Solidity: function verifyRandomness(((uint256,uint256),uint256,uint256,(uint256,uint256),(uint256,uint256),(uint256,uint256),uint256) _proof, uint256 _pkX, uint256 _pkY, bytes _nonce) view returns(bool _valid)
func (_TeeVRFVerifier *TeeVRFVerifierCallerSession) VerifyRandomness(_proof IVrfVerifierProof, _pkX *big.Int, _pkY *big.Int, _nonce []byte) (bool, error) {
	return _TeeVRFVerifier.Contract.VerifyRandomness(&_TeeVRFVerifier.CallOpts, _proof, _pkX, _pkY, _nonce)
}
