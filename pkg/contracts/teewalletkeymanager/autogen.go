...
// ConfirmKey is a paid mutator transaction binding the contract method 0x11107d29.
//
// Solidity: function confirmKey((address,bytes32,uint64,bytes32,bytes,bytes,uint256,uint256,uint8,bool,string,((bytes32,bytes32)[],uint64,address[],uint64,bytes),(address[],bytes)) _proof, (uint8,bytes32,bytes32) _teeSignature) returns()
