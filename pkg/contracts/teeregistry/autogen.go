...
// ConfirmReplicate is a paid mutator transaction binding the contract method 0xb379ebc6.
//
// Solidity: function confirmReplicate((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[],(bytes32,bytes32,uint16,uint64,address[],uint64,(address,string,uint256),(uint8,uint8,uint64,address,bytes32,bytes32,bytes32,uint24))) _proof) returns()
...
// PauseWithProof is a paid mutator transaction binding the contract method 0x9036bdb2.
//
// Solidity: function pauseWithProof((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[],(bytes32,bytes32,uint16,uint64,address[],uint64,(address,string,uint256),(uint8,uint8,uint64,address,bytes32,bytes32,bytes32,uint24))) _proof) returns()
...
// ReplicateFrom is a paid mutator transaction binding the contract method 0xe57f747c.
//
// Solidity: function replicateFrom(address _oldTeeId, (bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[],(bytes32,bytes32,uint16,uint64,address[],uint64,(address,string,uint256),(uint8,uint8,uint64,address,bytes32,bytes32,bytes32,uint24))) _proof, uint256 _teeUpgradeId) payable returns()
...
// ToProduction is a paid mutator transaction binding the contract method 0x7eb4909c.
//
// Solidity: function toProduction((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[],(bytes32,bytes32,uint16,uint64,address[],uint64,(address,string,uint256),(uint8,uint8,uint64,address,bytes32,bytes32,bytes32,uint24))) _proof) returns()
