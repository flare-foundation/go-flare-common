...
//
// Solidity: function confirmReplicate(address _newTeeId, (bytes,(uint8,bytes32,bytes32)[],(bytes32,bytes32,uint16,uint64,((address,address,string,bytes32,bytes32),uint24),(uint8))) _proof) payable returns()
