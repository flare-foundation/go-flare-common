...
// ConfirmAvailability is a paid mutator transaction binding the contract method 0xc84f0b19.
//
// Solidity: function confirmAvailability(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,string,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,bytes32),(bytes,bytes32,bytes,bytes32)) _proof) returns()
...
// VerifyAvailabilityCheckProof is a paid mutator transaction binding the contract method 0x113a0a4f.
//
// Solidity: function verifyAvailabilityCheckProof(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,string,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,bytes32),(bytes,bytes32,bytes,bytes32)) _proof) returns(bool _responseDataValid)
