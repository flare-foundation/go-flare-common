...
//
// Solidity: function requestPMWMultisigAccountConfiguredAttestation(bytes32 _walletId, bytes32 _sourceId, string _walletAddress, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationTransactor) RequestPMWMultisigAccountConfiguredAttestation(opts *bind.TransactOpts, _walletId [32]byte, _sourceId [32]byte, _walletAddress string, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.contract.Transact(opts, "requestPMWMultisigAccountConfiguredAttestation", _walletId, _sourceId, _walletAddress, _testOnTeeId)
}

// RequestPMWMultisigAccountConfiguredAttestation is a paid mutator transaction binding the contract method 0x87131d6c.
//
// Solidity: function requestPMWMultisigAccountConfiguredAttestation(bytes32 _walletId, bytes32 _sourceId, string _walletAddress, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationSession) RequestPMWMultisigAccountConfiguredAttestation(_walletId [32]byte, _sourceId [32]byte, _walletAddress string, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.Contract.RequestPMWMultisigAccountConfiguredAttestation(&_TeeVerification.TransactOpts, _walletId, _sourceId, _walletAddress, _testOnTeeId)
}

// RequestPMWMultisigAccountConfiguredAttestation is a paid mutator transaction binding the contract method 0x87131d6c.
//
// Solidity: function requestPMWMultisigAccountConfiguredAttestation(bytes32 _walletId, bytes32 _sourceId, string _walletAddress, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationTransactorSession) RequestPMWMultisigAccountConfiguredAttestation(_walletId [32]byte, _sourceId [32]byte, _walletAddress string, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.Contract.RequestPMWMultisigAccountConfiguredAttestation(&_TeeVerification.TransactOpts, _walletId, _sourceId, _walletAddress, _testOnTeeId)
}
...
// VerifyPMWMultisigAccountConfiguredProof is a paid mutator transaction binding the contract method 0x1f538891.
//
// Solidity: function verifyPMWMultisigAccountConfiguredProof(bytes32 _walletId, bytes32 _sourceId, ((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(string,bytes[],uint64),(uint8,uint64)) _proof) returns(bool _responseDataValid)
