...
// ConfirmAvailability is a paid mutator transaction binding the contract method 0xe87657c7.
//
// Solidity: function confirmAvailability(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,address,string,bytes32,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) _proof) returns()
...
// RequestAvailabilityCheckAttestation is a paid mutator transaction binding the contract method 0x4c23ecde.
//
// Solidity: function requestAvailabilityCheckAttestation(address _teeId, bytes32 _instructionId, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationTransactor) RequestAvailabilityCheckAttestation(opts *bind.TransactOpts, _teeId common.Address, _instructionId [32]byte, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.contract.Transact(opts, "requestAvailabilityCheckAttestation", _teeId, _instructionId, _testOnTeeId)
}

// RequestAvailabilityCheckAttestation is a paid mutator transaction binding the contract method 0x4c23ecde.
//
// Solidity: function requestAvailabilityCheckAttestation(address _teeId, bytes32 _instructionId, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationSession) RequestAvailabilityCheckAttestation(_teeId common.Address, _instructionId [32]byte, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.Contract.RequestAvailabilityCheckAttestation(&_TeeVerification.TransactOpts, _teeId, _instructionId, _testOnTeeId)
}

// RequestAvailabilityCheckAttestation is a paid mutator transaction binding the contract method 0x4c23ecde.
//
// Solidity: function requestAvailabilityCheckAttestation(address _teeId, bytes32 _instructionId, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationTransactorSession) RequestAvailabilityCheckAttestation(_teeId common.Address, _instructionId [32]byte, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.Contract.RequestAvailabilityCheckAttestation(&_TeeVerification.TransactOpts, _teeId, _instructionId, _testOnTeeId)
}

// RequestPMWMultisigAccountConfiguredAttestation is a paid mutator transaction binding the contract method 0x87131d6c.
//
// Solidity: function requestPMWMultisigAccountConfiguredAttestation(bytes32 _walletId, bytes32 _sourceId, string _accountAddress, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationTransactor) RequestPMWMultisigAccountConfiguredAttestation(opts *bind.TransactOpts, _walletId [32]byte, _sourceId [32]byte, _accountAddress string, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.contract.Transact(opts, "requestPMWMultisigAccountConfiguredAttestation", _walletId, _sourceId, _accountAddress, _testOnTeeId)
}

// RequestPMWMultisigAccountConfiguredAttestation is a paid mutator transaction binding the contract method 0x87131d6c.
//
// Solidity: function requestPMWMultisigAccountConfiguredAttestation(bytes32 _walletId, bytes32 _sourceId, string _accountAddress, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationSession) RequestPMWMultisigAccountConfiguredAttestation(_walletId [32]byte, _sourceId [32]byte, _accountAddress string, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.Contract.RequestPMWMultisigAccountConfiguredAttestation(&_TeeVerification.TransactOpts, _walletId, _sourceId, _accountAddress, _testOnTeeId)
}

// RequestPMWMultisigAccountConfiguredAttestation is a paid mutator transaction binding the contract method 0x87131d6c.
//
// Solidity: function requestPMWMultisigAccountConfiguredAttestation(bytes32 _walletId, bytes32 _sourceId, string _accountAddress, address _testOnTeeId) payable returns()
func (_TeeVerification *TeeVerificationTransactorSession) RequestPMWMultisigAccountConfiguredAttestation(_walletId [32]byte, _sourceId [32]byte, _accountAddress string, _testOnTeeId common.Address) (*types.Transaction, error) {
	return _TeeVerification.Contract.RequestPMWMultisigAccountConfiguredAttestation(&_TeeVerification.TransactOpts, _walletId, _sourceId, _accountAddress, _testOnTeeId)
}
...
// VerifyAvailabilityCheckProof is a paid mutator transaction binding the contract method 0x21c17185.
//
// Solidity: function verifyAvailabilityCheckProof(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,address,string,bytes32,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) _proof) returns(bool)
...
// VerifyPMWMultisigAccountConfiguredProof is a paid mutator transaction binding the contract method 0xe693ee13.
//
// Solidity: function verifyPMWMultisigAccountConfiguredProof(bytes32 _walletId, ((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(string,bytes[],uint64),(uint8,uint64)) _proof) returns(bool)
