...
// VerificationChallengeInvalidatedIterator is returned from FilterChallengeInvalidated and is used to iterate over the raw logs and unpacked data for ChallengeInvalidated events raised by the Verification contract.
type VerificationChallengeInvalidatedIterator struct {
	Event *VerificationChallengeInvalidated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *VerificationChallengeInvalidatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(VerificationChallengeInvalidated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *VerificationChallengeInvalidatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *VerificationChallengeInvalidatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// VerificationChallengeInvalidated represents a ChallengeInvalidated event raised by the Verification contract.
type VerificationChallengeInvalidated struct {
	TeeId common.Address
	Raw   types.Log // Blockchain specific contextual infos
}

// FilterChallengeInvalidated is a free log retrieval operation binding the contract event 0x58660ef7163b1c6a347cc269d6a8a088ca478bc4f44a53c041531a7f56e0303d.
//
// Solidity: event ChallengeInvalidated(address indexed teeId)
func (_Verification *VerificationFilterer) FilterChallengeInvalidated(opts *bind.FilterOpts, teeId []common.Address) (*VerificationChallengeInvalidatedIterator, error) {
	...
	logs, sub, err := _Verification.contract.FilterLogs(opts, "ChallengeInvalidated", teeIdRule)
	if err != nil {
		return nil, err
	}
	return &VerificationChallengeInvalidatedIterator{contract: _Verification.contract, event: "ChallengeInvalidated", logs: logs, sub: sub}, nil
}

// WatchChallengeInvalidated is a free log subscription operation binding the contract event 0x58660ef7163b1c6a347cc269d6a8a088ca478bc4f44a53c041531a7f56e0303d.
//
// Solidity: event ChallengeInvalidated(address indexed teeId)
func (_Verification *VerificationFilterer) WatchChallengeInvalidated(opts *bind.WatchOpts, sink chan<- *VerificationChallengeInvalidated, teeId []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Verification.contract.WatchLogs(opts, "ChallengeInvalidated", teeIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(VerificationChallengeInvalidated)
				if err := _Verification.contract.UnpackLog(event, "ChallengeInvalidated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseChallengeInvalidated is a log parse operation binding the contract event 0x58660ef7163b1c6a347cc269d6a8a088ca478bc4f44a53c041531a7f56e0303d.
//
// Solidity: event ChallengeInvalidated(address indexed teeId)
func (_Verification *VerificationFilterer) ParseChallengeInvalidated(log types.Log) (*VerificationChallengeInvalidated, error) {
	event := new(VerificationChallengeInvalidated)
	if err := _Verification.contract.UnpackLog(event, "ChallengeInvalidated", log); err != nil {
		return nil, err
	}
...
// VerificationInitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the Verification contract.
type VerificationInitializedIterator struct {
	Event *VerificationInitialized // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *VerificationInitializedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(VerificationInitialized)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *VerificationInitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *VerificationInitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Verification *VerificationFilterer) FilterInitialized(opts *bind.FilterOpts) (*VerificationInitializedIterator, error) {

	logs, sub, err := _Verification.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &VerificationInitializedIterator{contract: _Verification.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0xc7f505b2f371ae2175ee4913f4499e1f2633a7b5936321eed1cdaeb6115181d2.
//
// Solidity: event Initialized(uint64 version)
func (_Verification *VerificationFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *VerificationInitialized) (event.Subscription, error) {

	logs, sub, err := _Verification.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(VerificationInitialized)
				if err := _Verification.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint64 version)
func (_Verification *VerificationFilterer) ParseInitialized(log types.Log) (*VerificationInitialized, error) {
	event := new(VerificationInitialized)
	if err := _Verification.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
