...
func (_TeePaymentsBase *TeePaymentsBaseCaller) AddressValidator(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TeePaymentsBase.contract.Call(opts, &out, "addressValidator")
...
//
// Solidity: function addressValidator() view returns(address)
func (_TeePaymentsBase *TeePaymentsBaseSession) AddressValidator() (common.Address, error) {
	return _TeePaymentsBase.Contract.AddressValidator(&_TeePaymentsBase.CallOpts)
}

// AddressValidator is a free data retrieval call binding the contract method 0xe37facf4.
//
// Solidity: function addressValidator() view returns(address)
func (_TeePaymentsBase *TeePaymentsBaseCallerSession) AddressValidator() (common.Address, error) {
	return _TeePaymentsBase.Contract.AddressValidator(&_TeePaymentsBase.CallOpts)
}
...
func (_TeePaymentsBase *TeePaymentsBaseCaller) GetNextPaymentId(opts *bind.CallOpts, _account ITeePaymentsBasePMWMultisigAccount) (uint64, error) {
	var out []interface{}
	err := _TeePaymentsBase.contract.Call(opts, &out, "getNextPaymentId", _account)
...
//
// Solidity: function getNextPaymentId((bytes32,string) _account) view returns(uint64 _nextPaymentId)
func (_TeePaymentsBase *TeePaymentsBaseSession) GetNextPaymentId(_account ITeePaymentsBasePMWMultisigAccount) (uint64, error) {
	return _TeePaymentsBase.Contract.GetNextPaymentId(&_TeePaymentsBase.CallOpts, _account)
}

// GetNextPaymentId is a free data retrieval call binding the contract method 0xfb49ac30.
//
// Solidity: function getNextPaymentId((bytes32,string) _account) view returns(uint64 _nextPaymentId)
func (_TeePaymentsBase *TeePaymentsBaseCallerSession) GetNextPaymentId(_account ITeePaymentsBasePMWMultisigAccount) (uint64, error) {
	return _TeePaymentsBase.Contract.GetNextPaymentId(&_TeePaymentsBase.CallOpts, _account)
}
...
func (_TeePaymentsBase *TeePaymentsBaseCaller) GetPaymentHash(opts *bind.CallOpts, _account ITeePaymentsBasePMWMultisigAccount, _paymentId uint64) ([32]byte, error) {
	var out []interface{}
	err := _TeePaymentsBase.contract.Call(opts, &out, "getPaymentHash", _account, _paymentId)
...
//
// Solidity: function getPaymentHash((bytes32,string) _account, uint64 _paymentId) view returns(bytes32 _paymentHash)
func (_TeePaymentsBase *TeePaymentsBaseSession) GetPaymentHash(_account ITeePaymentsBasePMWMultisigAccount, _paymentId uint64) ([32]byte, error) {
	return _TeePaymentsBase.Contract.GetPaymentHash(&_TeePaymentsBase.CallOpts, _account, _paymentId)
}

// GetPaymentHash is a free data retrieval call binding the contract method 0x0079dfe8.
//
// Solidity: function getPaymentHash((bytes32,string) _account, uint64 _paymentId) view returns(bytes32 _paymentHash)
func (_TeePaymentsBase *TeePaymentsBaseCallerSession) GetPaymentHash(_account ITeePaymentsBasePMWMultisigAccount, _paymentId uint64) ([32]byte, error) {
	return _TeePaymentsBase.Contract.GetPaymentHash(&_TeePaymentsBase.CallOpts, _account, _paymentId)
}
...
func (_TeePaymentsBase *TeePaymentsBaseTransactor) Reissue(opts *bind.TransactOpts, _account ITeePaymentsBasePMWMultisigAccount, _batchPaymentId uint64, _paymentInstructions []ITeePaymentsBasePaymentInstruction, _reissueFeeParams ITeePaymentsBaseReissueFeeParams, _startNew bool, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePaymentsBase.contract.Transact(opts, "reissue", _account, _batchPaymentId, _paymentInstructions, _reissueFeeParams, _startNew, _claimBackAddress)
}

// Reissue is a paid mutator transaction binding the contract method 0x1abcad2c.
//
// Solidity: function reissue((bytes32,string) _account, uint64 _batchPaymentId, (string,bytes,uint256,uint256,bytes32)[] _paymentInstructions, (uint256[],int16[][],uint16[]) _reissueFeeParams, bool _startNew, address _claimBackAddress) payable returns(bool _finalized)
func (_TeePaymentsBase *TeePaymentsBaseSession) Reissue(_account ITeePaymentsBasePMWMultisigAccount, _batchPaymentId uint64, _paymentInstructions []ITeePaymentsBasePaymentInstruction, _reissueFeeParams ITeePaymentsBaseReissueFeeParams, _startNew bool, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePaymentsBase.Contract.Reissue(&_TeePaymentsBase.TransactOpts, _account, _batchPaymentId, _paymentInstructions, _reissueFeeParams, _startNew, _claimBackAddress)
}

// Reissue is a paid mutator transaction binding the contract method 0x1abcad2c.
//
// Solidity: function reissue((bytes32,string) _account, uint64 _batchPaymentId, (string,bytes,uint256,uint256,bytes32)[] _paymentInstructions, (uint256[],int16[][],uint16[]) _reissueFeeParams, bool _startNew, address _claimBackAddress) payable returns(bool _finalized)
func (_TeePaymentsBase *TeePaymentsBaseTransactorSession) Reissue(_account ITeePaymentsBasePMWMultisigAccount, _batchPaymentId uint64, _paymentInstructions []ITeePaymentsBasePaymentInstruction, _reissueFeeParams ITeePaymentsBaseReissueFeeParams, _startNew bool, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePaymentsBase.Contract.Reissue(&_TeePaymentsBase.TransactOpts, _account, _batchPaymentId, _paymentInstructions, _reissueFeeParams, _startNew, _claimBackAddress)
}
