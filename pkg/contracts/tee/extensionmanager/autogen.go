...
// GetExtensionOperator is a free data retrieval call binding the contract method 0xb69caaca.
//
// Solidity: function getExtensionOperator(uint256 _extensionId) view returns(address)
func (_ExtensionManager *ExtensionManagerCaller) GetExtensionOperator(opts *bind.CallOpts, _extensionId *big.Int) (common.Address, error) {
	var out []interface{}
	err := _ExtensionManager.contract.Call(opts, &out, "getExtensionOperator", _extensionId)
...
//
// Solidity: function getExtensionOperator(uint256 _extensionId) view returns(address)
func (_ExtensionManager *ExtensionManagerSession) GetExtensionOperator(_extensionId *big.Int) (common.Address, error) {
	return _ExtensionManager.Contract.GetExtensionOperator(&_ExtensionManager.CallOpts, _extensionId)
}

// GetExtensionOperator is a free data retrieval call binding the contract method 0xb69caaca.
//
// Solidity: function getExtensionOperator(uint256 _extensionId) view returns(address)
func (_ExtensionManager *ExtensionManagerCallerSession) GetExtensionOperator(_extensionId *big.Int) (common.Address, error) {
	return _ExtensionManager.Contract.GetExtensionOperator(&_ExtensionManager.CallOpts, _extensionId)
}
...
// NextPublicExtensionId is a free data retrieval call binding the contract method 0x27582ad5.
//
// Solidity: function nextPublicExtensionId() view returns(uint256)
func (_ExtensionManager *ExtensionManagerCaller) NextPublicExtensionId(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ExtensionManager.contract.Call(opts, &out, "nextPublicExtensionId")
...
//
// Solidity: function nextPublicExtensionId() view returns(uint256)
func (_ExtensionManager *ExtensionManagerSession) NextPublicExtensionId() (*big.Int, error) {
	return _ExtensionManager.Contract.NextPublicExtensionId(&_ExtensionManager.CallOpts)
}

// NextPublicExtensionId is a free data retrieval call binding the contract method 0x27582ad5.
//
// Solidity: function nextPublicExtensionId() view returns(uint256)
func (_ExtensionManager *ExtensionManagerCallerSession) NextPublicExtensionId() (*big.Int, error) {
	return _ExtensionManager.Contract.NextPublicExtensionId(&_ExtensionManager.CallOpts)
}
...
// AddTeeVersion is a paid mutator transaction binding the contract method 0x2cf2ca0e.
//
// Solidity: function addTeeVersion(uint256 _extensionId, bytes32 _version, bytes32 _codeHash, bytes32[] _platforms) returns()
func (_ExtensionManager *ExtensionManagerTransactor) AddTeeVersion(opts *bind.TransactOpts, _extensionId *big.Int, _version [32]byte, _codeHash [32]byte, _platforms [][32]byte) (*types.Transaction, error) {
	return _ExtensionManager.contract.Transact(opts, "addTeeVersion", _extensionId, _version, _codeHash, _platforms)
}

// AddTeeVersion is a paid mutator transaction binding the contract method 0x2cf2ca0e.
//
// Solidity: function addTeeVersion(uint256 _extensionId, bytes32 _version, bytes32 _codeHash, bytes32[] _platforms) returns()
func (_ExtensionManager *ExtensionManagerSession) AddTeeVersion(_extensionId *big.Int, _version [32]byte, _codeHash [32]byte, _platforms [][32]byte) (*types.Transaction, error) {
	return _ExtensionManager.Contract.AddTeeVersion(&_ExtensionManager.TransactOpts, _extensionId, _version, _codeHash, _platforms)
}

// AddTeeVersion is a paid mutator transaction binding the contract method 0x2cf2ca0e.
//
// Solidity: function addTeeVersion(uint256 _extensionId, bytes32 _version, bytes32 _codeHash, bytes32[] _platforms) returns()
func (_ExtensionManager *ExtensionManagerTransactorSession) AddTeeVersion(_extensionId *big.Int, _version [32]byte, _codeHash [32]byte, _platforms [][32]byte) (*types.Transaction, error) {
	return _ExtensionManager.Contract.AddTeeVersion(&_ExtensionManager.TransactOpts, _extensionId, _version, _codeHash, _platforms)
}
...
// RegisterReserved is a paid mutator transaction binding the contract method 0xbf59ac18.
//
// Solidity: function registerReserved(uint256 _extensionId, address _owner) returns()
func (_ExtensionManager *ExtensionManagerTransactor) RegisterReserved(opts *bind.TransactOpts, _extensionId *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _ExtensionManager.contract.Transact(opts, "registerReserved", _extensionId, _owner)
}

// RegisterReserved is a paid mutator transaction binding the contract method 0xbf59ac18.
//
// Solidity: function registerReserved(uint256 _extensionId, address _owner) returns()
func (_ExtensionManager *ExtensionManagerSession) RegisterReserved(_extensionId *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _ExtensionManager.Contract.RegisterReserved(&_ExtensionManager.TransactOpts, _extensionId, _owner)
}

// RegisterReserved is a paid mutator transaction binding the contract method 0xbf59ac18.
//
// Solidity: function registerReserved(uint256 _extensionId, address _owner) returns()
func (_ExtensionManager *ExtensionManagerTransactorSession) RegisterReserved(_extensionId *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _ExtensionManager.Contract.RegisterReserved(&_ExtensionManager.TransactOpts, _extensionId, _owner)
}
...
// SetExtensionOperator is a paid mutator transaction binding the contract method 0x868843b9.
//
// Solidity: function setExtensionOperator(uint256 _extensionId, address _operator) returns()
func (_ExtensionManager *ExtensionManagerTransactor) SetExtensionOperator(opts *bind.TransactOpts, _extensionId *big.Int, _operator common.Address) (*types.Transaction, error) {
	return _ExtensionManager.contract.Transact(opts, "setExtensionOperator", _extensionId, _operator)
}

// SetExtensionOperator is a paid mutator transaction binding the contract method 0x868843b9.
//
// Solidity: function setExtensionOperator(uint256 _extensionId, address _operator) returns()
func (_ExtensionManager *ExtensionManagerSession) SetExtensionOperator(_extensionId *big.Int, _operator common.Address) (*types.Transaction, error) {
...
//
// Solidity: function setExtensionOperator(uint256 _extensionId, address _operator) returns()
func (_ExtensionManager *ExtensionManagerTransactorSession) SetExtensionOperator(_extensionId *big.Int, _operator common.Address) (*types.Transaction, error) {
	return _ExtensionManager.Contract.SetExtensionOperator(&_ExtensionManager.TransactOpts, _extensionId, _operator)
}
...
// ExtensionManagerExtensionOperatorSetIterator is returned from FilterExtensionOperatorSet and is used to iterate over the raw logs and unpacked data for ExtensionOperatorSet events raised by the ExtensionManager contract.
type ExtensionManagerExtensionOperatorSetIterator struct {
	Event *ExtensionManagerExtensionOperatorSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExtensionManagerExtensionOperatorSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExtensionManagerExtensionOperatorSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExtensionManagerExtensionOperatorSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExtensionManagerExtensionOperatorSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
// FilterExtensionOperatorSet is a free log retrieval operation binding the contract event 0xb77f1ac9c5126ae326ea54af75b1240e4353002c10c5cfb2b9244b8e5d356e78.
//
// Solidity: event ExtensionOperatorSet(uint256 indexed extensionId, address indexed oldOperator, address indexed newOperator)
func (_ExtensionManager *ExtensionManagerFilterer) FilterExtensionOperatorSet(opts *bind.FilterOpts, extensionId []*big.Int, oldOperator []common.Address, newOperator []common.Address) (*ExtensionManagerExtensionOperatorSetIterator, error) {
	...
	logs, sub, err := _ExtensionManager.contract.FilterLogs(opts, "ExtensionOperatorSet", extensionIdRule, oldOperatorRule, newOperatorRule)
	if err != nil {
		return nil, err
	}
	return &ExtensionManagerExtensionOperatorSetIterator{contract: _ExtensionManager.contract, event: "ExtensionOperatorSet", logs: logs, sub: sub}, nil
}

// WatchExtensionOperatorSet is a free log subscription operation binding the contract event 0xb77f1ac9c5126ae326ea54af75b1240e4353002c10c5cfb2b9244b8e5d356e78.
//
// Solidity: event ExtensionOperatorSet(uint256 indexed extensionId, address indexed oldOperator, address indexed newOperator)
func (_ExtensionManager *ExtensionManagerFilterer) WatchExtensionOperatorSet(opts *bind.WatchOpts, sink chan<- *ExtensionManagerExtensionOperatorSet, extensionId []*big.Int, oldOperator []common.Address, newOperator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ExtensionManager.contract.WatchLogs(opts, "ExtensionOperatorSet", extensionIdRule, oldOperatorRule, newOperatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExtensionManagerExtensionOperatorSet)
				if err := _ExtensionManager.contract.UnpackLog(event, "ExtensionOperatorSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseExtensionOperatorSet is a log parse operation binding the contract event 0xb77f1ac9c5126ae326ea54af75b1240e4353002c10c5cfb2b9244b8e5d356e78.
//
// Solidity: event ExtensionOperatorSet(uint256 indexed extensionId, address indexed oldOperator, address indexed newOperator)
func (_ExtensionManager *ExtensionManagerFilterer) ParseExtensionOperatorSet(log types.Log) (*ExtensionManagerExtensionOperatorSet, error) {
	event := new(ExtensionManagerExtensionOperatorSet)
	if err := _ExtensionManager.contract.UnpackLog(event, "ExtensionOperatorSet", log); err != nil {
		return nil, err
	}
...
// ExtensionManagerInitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the ExtensionManager contract.
type ExtensionManagerInitializedIterator struct {
	Event *ExtensionManagerInitialized // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExtensionManagerInitializedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExtensionManagerInitialized)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExtensionManagerInitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExtensionManagerInitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_ExtensionManager *ExtensionManagerFilterer) FilterInitialized(opts *bind.FilterOpts) (*ExtensionManagerInitializedIterator, error) {

	logs, sub, err := _ExtensionManager.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &ExtensionManagerInitializedIterator{contract: _ExtensionManager.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0xc7f505b2f371ae2175ee4913f4499e1f2633a7b5936321eed1cdaeb6115181d2.
//
// Solidity: event Initialized(uint64 version)
func (_ExtensionManager *ExtensionManagerFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *ExtensionManagerInitialized) (event.Subscription, error) {

	logs, sub, err := _ExtensionManager.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExtensionManagerInitialized)
				if err := _ExtensionManager.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint64 version)
func (_ExtensionManager *ExtensionManagerFilterer) ParseInitialized(log types.Log) (*ExtensionManagerInitialized, error) {
	event := new(ExtensionManagerInitialized)
	if err := _ExtensionManager.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
...
// ExtensionManagerTeeMachineStatusChangedIterator is returned from FilterTeeMachineStatusChanged and is used to iterate over the raw logs and unpacked data for TeeMachineStatusChanged events raised by the ExtensionManager contract.
type ExtensionManagerTeeMachineStatusChangedIterator struct {
	Event *ExtensionManagerTeeMachineStatusChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExtensionManagerTeeMachineStatusChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExtensionManagerTeeMachineStatusChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExtensionManagerTeeMachineStatusChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExtensionManagerTeeMachineStatusChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_ExtensionManager *ExtensionManagerFilterer) FilterTeeMachineStatusChanged(opts *bind.FilterOpts, teeId []common.Address, newStatus []uint8) (*ExtensionManagerTeeMachineStatusChangedIterator, error) {
	...
	logs, sub, err := _ExtensionManager.contract.FilterLogs(opts, "TeeMachineStatusChanged", teeIdRule, newStatusRule)
	if err != nil {
		return nil, err
	}
	return &ExtensionManagerTeeMachineStatusChangedIterator{contract: _ExtensionManager.contract, event: "TeeMachineStatusChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TeeMachineStatusChanged(address indexed teeId, uint8 indexed newStatus)
func (_ExtensionManager *ExtensionManagerFilterer) WatchTeeMachineStatusChanged(opts *bind.WatchOpts, sink chan<- *ExtensionManagerTeeMachineStatusChanged, teeId []common.Address, newStatus []uint8) (event.Subscription, error) {
	...
	logs, sub, err := _ExtensionManager.contract.WatchLogs(opts, "TeeMachineStatusChanged", teeIdRule, newStatusRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExtensionManagerTeeMachineStatusChanged)
				if err := _ExtensionManager.contract.UnpackLog(event, "TeeMachineStatusChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TeeMachineStatusChanged(address indexed teeId, uint8 indexed newStatus)
func (_ExtensionManager *ExtensionManagerFilterer) ParseTeeMachineStatusChanged(log types.Log) (*ExtensionManagerTeeMachineStatusChanged, error) {
	event := new(ExtensionManagerTeeMachineStatusChanged)
	if err := _ExtensionManager.contract.UnpackLog(event, "TeeMachineStatusChanged", log); err != nil {
		return nil, err
	}
...
// FilterTeeVersionAdded is a free log retrieval operation binding the contract event 0x23780d55ed207185f9a9e31084b08b42f9b5d75a44ea81673ddfdc36f45ef5b2.
//
...
// WatchTeeVersionAdded is a free log subscription operation binding the contract event 0x23780d55ed207185f9a9e31084b08b42f9b5d75a44ea81673ddfdc36f45ef5b2.
//
// Solidity: event TeeVersionAdded(uint256 indexed extensionId, bytes32 version, bytes32 indexed codeHash, bytes32[] platforms)
...
// ParseTeeVersionAdded is a log parse operation binding the contract event 0x23780d55ed207185f9a9e31084b08b42f9b5d75a44ea81673ddfdc36f45ef5b2.
//
// Solidity: event TeeVersionAdded(uint256 indexed extensionId, bytes32 version, bytes32 indexed codeHash, bytes32[] platforms)
