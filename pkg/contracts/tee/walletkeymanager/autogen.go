...
// GetKeyNonce is a free data retrieval call binding the contract method 0x60d8ff13.
//
...
func (_WalletKeyManager *WalletKeyManagerCaller) GetKeyNonce(opts *bind.CallOpts, _teeId common.Address, _walletId [32]byte, _keyId uint64) (struct {
	Nonce       *big.Int
	TeeHoldsKey bool
}, error) {
	var out []interface{}
	err := _WalletKeyManager.contract.Call(opts, &out, "getKeyNonce", _teeId, _walletId, _keyId)
...
//
// Solidity: function getKeyNonce(address _teeId, bytes32 _walletId, uint64 _keyId) view returns(uint256 _nonce, bool _teeHoldsKey)
func (_WalletKeyManager *WalletKeyManagerSession) GetKeyNonce(_teeId common.Address, _walletId [32]byte, _keyId uint64) (struct {
	Nonce       *big.Int
	TeeHoldsKey bool
}, error) {
	return _WalletKeyManager.Contract.GetKeyNonce(&_WalletKeyManager.CallOpts, _teeId, _walletId, _keyId)
}

// GetKeyNonce is a free data retrieval call binding the contract method 0x60d8ff13.
//
// Solidity: function getKeyNonce(address _teeId, bytes32 _walletId, uint64 _keyId) view returns(uint256 _nonce, bool _teeHoldsKey)
func (_WalletKeyManager *WalletKeyManagerCallerSession) GetKeyNonce(_teeId common.Address, _walletId [32]byte, _keyId uint64) (struct {
	Nonce       *big.Int
	TeeHoldsKey bool
}, error) {
	return _WalletKeyManager.Contract.GetKeyNonce(&_WalletKeyManager.CallOpts, _teeId, _walletId, _keyId)
...
// GetReceivingTeeIds is a free data retrieval call binding the contract method 0x8184ce4b.
//
// Solidity: function getReceivingTeeIds(bytes32 _walletId) view returns(address[] _teeIds)
func (_WalletKeyManager *WalletKeyManagerCaller) GetReceivingTeeIds(opts *bind.CallOpts, _walletId [32]byte) ([]common.Address, error) {
	var out []interface{}
	err := _WalletKeyManager.contract.Call(opts, &out, "getReceivingTeeIds", _walletId)
...
//
// Solidity: function getReceivingTeeIds(bytes32 _walletId) view returns(address[] _teeIds)
func (_WalletKeyManager *WalletKeyManagerSession) GetReceivingTeeIds(_walletId [32]byte) ([]common.Address, error) {
	return _WalletKeyManager.Contract.GetReceivingTeeIds(&_WalletKeyManager.CallOpts, _walletId)
}

// GetReceivingTeeIds is a free data retrieval call binding the contract method 0x8184ce4b.
//
// Solidity: function getReceivingTeeIds(bytes32 _walletId) view returns(address[] _teeIds)
func (_WalletKeyManager *WalletKeyManagerCallerSession) GetReceivingTeeIds(_walletId [32]byte) ([]common.Address, error) {
	return _WalletKeyManager.Contract.GetReceivingTeeIds(&_WalletKeyManager.CallOpts, _walletId)
}
...
// GetWalletPublicKeys is a free data retrieval call binding the contract method 0x6205085f.
//
// Solidity: function getWalletPublicKeys(bytes32 _walletId) view returns(uint64 _multisigThreshold, bytes[] _publicKeys)
func (_WalletKeyManager *WalletKeyManagerCaller) GetWalletPublicKeys(opts *bind.CallOpts, _walletId [32]byte) (struct {
	MultisigThreshold uint64
	PublicKeys        [][]byte
}, error) {
	var out []interface{}
	err := _WalletKeyManager.contract.Call(opts, &out, "getWalletPublicKeys", _walletId)
...
//
// Solidity: function getWalletPublicKeys(bytes32 _walletId) view returns(uint64 _multisigThreshold, bytes[] _publicKeys)
func (_WalletKeyManager *WalletKeyManagerSession) GetWalletPublicKeys(_walletId [32]byte) (struct {
	MultisigThreshold uint64
	PublicKeys        [][]byte
}, error) {
	return _WalletKeyManager.Contract.GetWalletPublicKeys(&_WalletKeyManager.CallOpts, _walletId)
}

// GetWalletPublicKeys is a free data retrieval call binding the contract method 0x6205085f.
//
// Solidity: function getWalletPublicKeys(bytes32 _walletId) view returns(uint64 _multisigThreshold, bytes[] _publicKeys)
func (_WalletKeyManager *WalletKeyManagerCallerSession) GetWalletPublicKeys(_walletId [32]byte) (struct {
	MultisigThreshold uint64
	PublicKeys        [][]byte
}, error) {
	return _WalletKeyManager.Contract.GetWalletPublicKeys(&_WalletKeyManager.CallOpts, _walletId)
