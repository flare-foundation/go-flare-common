...
func (_TeePaymentsLimitsManager *TeePaymentsLimitsManagerCaller) GetPaymentLimitsNonce(opts *bind.CallOpts, _account ITeePaymentsBasePMWMultisigAccount) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getPaymentLimitsNonce((bytes32,string) _account) view returns(uint256 _nonce)
func (_TeePaymentsLimitsManager *TeePaymentsLimitsManagerSession) GetPaymentLimitsNonce(_account ITeePaymentsBasePMWMultisigAccount) (*big.Int, error) {
...
//
// Solidity: function getPaymentLimitsNonce((bytes32,string) _account) view returns(uint256 _nonce)
func (_TeePaymentsLimitsManager *TeePaymentsLimitsManagerCallerSession) GetPaymentLimitsNonce(_account ITeePaymentsBasePMWMultisigAccount) (*big.Int, error) {
	return _TeePaymentsLimitsManager.Contract.GetPaymentLimitsNonce(&_TeePaymentsLimitsManager.CallOpts, _account)
}
...
func (_TeePaymentsLimitsManager *TeePaymentsLimitsManagerTransactor) SetPaymentLimits(opts *bind.TransactOpts, _account ITeePaymentsBasePMWMultisigAccount, _transactionLimit *big.Int, _dailyLimit *big.Int, _claimBackAddress common.Address) (*types.Transaction, error) {
...
//
// Solidity: function setPaymentLimits((bytes32,string) _account, uint256 _transactionLimit, uint256 _dailyLimit, address _claimBackAddress) payable returns()
func (_TeePaymentsLimitsManager *TeePaymentsLimitsManagerSession) SetPaymentLimits(_account ITeePaymentsBasePMWMultisigAccount, _transactionLimit *big.Int, _dailyLimit *big.Int, _claimBackAddress common.Address) (*types.Transaction, error) {
...
//
// Solidity: function setPaymentLimits((bytes32,string) _account, uint256 _transactionLimit, uint256 _dailyLimit, address _claimBackAddress) payable returns()
func (_TeePaymentsLimitsManager *TeePaymentsLimitsManagerTransactorSession) SetPaymentLimits(_account ITeePaymentsBasePMWMultisigAccount, _transactionLimit *big.Int, _dailyLimit *big.Int, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePaymentsLimitsManager.Contract.SetPaymentLimits(&_TeePaymentsLimitsManager.TransactOpts, _account, _transactionLimit, _dailyLimit, _claimBackAddress)
}
