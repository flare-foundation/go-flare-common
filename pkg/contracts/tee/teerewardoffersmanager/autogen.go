...
// TeeRewardOffersManagerTeeOwnersPPMSetIterator is returned from FilterTeeOwnersPPMSet and is used to iterate over the raw logs and unpacked data for TeeOwnersPPMSet events raised by the TeeRewardOffersManager contract.
type TeeRewardOffersManagerTeeOwnersPPMSetIterator struct {
	Event *TeeRewardOffersManagerTeeOwnersPPMSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TeeRewardOffersManagerTeeOwnersPPMSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TeeRewardOffersManagerTeeOwnersPPMSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TeeRewardOffersManagerTeeOwnersPPMSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TeeRewardOffersManagerTeeOwnersPPMSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
// FilterTeeOwnersPPMSet is a free log retrieval operation binding the contract event 0x27a5b08f26481d9c60fd6a2d928f150ce2cdb645897ced88dd07e29543f207dd.
//
// Solidity: event TeeOwnersPPMSet(uint24 teeOwnersPPM)
func (_TeeRewardOffersManager *TeeRewardOffersManagerFilterer) FilterTeeOwnersPPMSet(opts *bind.FilterOpts) (*TeeRewardOffersManagerTeeOwnersPPMSetIterator, error) {

	logs, sub, err := _TeeRewardOffersManager.contract.FilterLogs(opts, "TeeOwnersPPMSet")
	if err != nil {
		return nil, err
	}
	return &TeeRewardOffersManagerTeeOwnersPPMSetIterator{contract: _TeeRewardOffersManager.contract, event: "TeeOwnersPPMSet", logs: logs, sub: sub}, nil
}

// WatchTeeOwnersPPMSet is a free log subscription operation binding the contract event 0x27a5b08f26481d9c60fd6a2d928f150ce2cdb645897ced88dd07e29543f207dd.
//
// Solidity: event TeeOwnersPPMSet(uint24 teeOwnersPPM)
func (_TeeRewardOffersManager *TeeRewardOffersManagerFilterer) WatchTeeOwnersPPMSet(opts *bind.WatchOpts, sink chan<- *TeeRewardOffersManagerTeeOwnersPPMSet) (event.Subscription, error) {

	logs, sub, err := _TeeRewardOffersManager.contract.WatchLogs(opts, "TeeOwnersPPMSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TeeRewardOffersManagerTeeOwnersPPMSet)
				if err := _TeeRewardOffersManager.contract.UnpackLog(event, "TeeOwnersPPMSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTeeOwnersPPMSet is a log parse operation binding the contract event 0x27a5b08f26481d9c60fd6a2d928f150ce2cdb645897ced88dd07e29543f207dd.
//
// Solidity: event TeeOwnersPPMSet(uint24 teeOwnersPPM)
func (_TeeRewardOffersManager *TeeRewardOffersManagerFilterer) ParseTeeOwnersPPMSet(log types.Log) (*TeeRewardOffersManagerTeeOwnersPPMSet, error) {
	event := new(TeeRewardOffersManagerTeeOwnersPPMSet)
	if err := _TeeRewardOffersManager.contract.UnpackLog(event, "TeeOwnersPPMSet", log); err != nil {
		return nil, err
	}
