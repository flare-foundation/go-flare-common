...
func (_FtdcHub *FtdcHubCaller) TeeInstructions(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _FtdcHub.contract.Call(opts, &out, "teeInstructions")
...
//
// Solidity: function teeInstructions() view returns(address)
func (_FtdcHub *FtdcHubSession) TeeInstructions() (common.Address, error) {
	return _FtdcHub.Contract.TeeInstructions(&_FtdcHub.CallOpts)
}

// TeeInstructions is a free data retrieval call binding the contract method 0xa3f000ce.
//
// Solidity: function teeInstructions() view returns(address)
func (_FtdcHub *FtdcHubCallerSession) TeeInstructions() (common.Address, error) {
	return _FtdcHub.Contract.TeeInstructions(&_FtdcHub.CallOpts)
}
