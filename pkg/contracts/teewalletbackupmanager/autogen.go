...
// BackupRestore is a paid mutator transaction binding the contract method 0x845dc93c.
//
// Solidity: function backupRestore(address _teeId, (address,bytes32,uint64,bytes32,bytes32,bytes,uint24,uint256) _backupId, string _backupUrl, bool _test) payable returns()
