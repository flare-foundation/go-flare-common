...
// KEYDATAPROVIDERRESTORETEST is a free data retrieval call binding the contract method 0x76fdba0b.
//
// Solidity: function KEY_DATA_PROVIDER_RESTORE_TEST() view returns(bytes32)
func (_TeeWalletBackupManager *TeeWalletBackupManagerCaller) KEYDATAPROVIDERRESTORETEST(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _TeeWalletBackupManager.contract.Call(opts, &out, "KEY_DATA_PROVIDER_RESTORE_TEST")
...
//
// Solidity: function KEY_DATA_PROVIDER_RESTORE_TEST() view returns(bytes32)
func (_TeeWalletBackupManager *TeeWalletBackupManagerSession) KEYDATAPROVIDERRESTORETEST() ([32]byte, error) {
	return _TeeWalletBackupManager.Contract.KEYDATAPROVIDERRESTORETEST(&_TeeWalletBackupManager.CallOpts)
}

// KEYDATAPROVIDERRESTORETEST is a free data retrieval call binding the contract method 0x76fdba0b.
//
// Solidity: function KEY_DATA_PROVIDER_RESTORE_TEST() view returns(bytes32)
func (_TeeWalletBackupManager *TeeWalletBackupManagerCallerSession) KEYDATAPROVIDERRESTORETEST() ([32]byte, error) {
	return _TeeWalletBackupManager.Contract.KEYDATAPROVIDERRESTORETEST(&_TeeWalletBackupManager.CallOpts)
}
