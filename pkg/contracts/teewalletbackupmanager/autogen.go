...
// BackupRestore is a paid mutator transaction binding the contract method 0x162aad1d.
//
// Solidity: function backupRestore(address _teeId, (address,bytes32,uint64,bytes32,bytes32,bytes,uint32,bytes32) _backupId, string _backupUrl) payable returns()
