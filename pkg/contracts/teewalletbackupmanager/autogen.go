...
func (_TeeWalletBackupManager *TeeWalletBackupManagerTransactor) BackupRestore(opts *bind.TransactOpts, _teeId common.Address, _backupId IWalletBackupManagerBackupId, _backupUrl string, _claimBackAddress common.Address) (*types.Transaction, error) {
...
//
// Solidity: function backupRestore(address _teeId, (address,bytes32,uint64,bytes32,bytes32,bytes,uint32,bytes32) _backupId, string _backupUrl, address _claimBackAddress) payable returns()
func (_TeeWalletBackupManager *TeeWalletBackupManagerSession) BackupRestore(_teeId common.Address, _backupId IWalletBackupManagerBackupId, _backupUrl string, _claimBackAddress common.Address) (*types.Transaction, error) {
...
//
// Solidity: function backupRestore(address _teeId, (address,bytes32,uint64,bytes32,bytes32,bytes,uint32,bytes32) _backupId, string _backupUrl, address _claimBackAddress) payable returns()
func (_TeeWalletBackupManager *TeeWalletBackupManagerTransactorSession) BackupRestore(_teeId common.Address, _backupId IWalletBackupManagerBackupId, _backupUrl string, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeWalletBackupManager.Contract.BackupRestore(&_TeeWalletBackupManager.TransactOpts, _teeId, _backupId, _backupUrl, _claimBackAddress)
}
