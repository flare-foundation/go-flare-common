...
func (_TeeMachineRegistry *TeeMachineRegistryCaller) GetTeeMachine(opts *bind.CallOpts, _teeId common.Address) (IMachineManagerTeeMachine, error) {
	var out []interface{}
...
//
// Solidity: function getTeeMachine(address _teeId) view returns((address,address,string))
func (_TeeMachineRegistry *TeeMachineRegistrySession) GetTeeMachine(_teeId common.Address) (IMachineManagerTeeMachine, error) {
...
//
// Solidity: function getTeeMachine(address _teeId) view returns((address,address,string))
func (_TeeMachineRegistry *TeeMachineRegistryCallerSession) GetTeeMachine(_teeId common.Address) (IMachineManagerTeeMachine, error) {
	return _TeeMachineRegistry.Contract.GetTeeMachine(&_TeeMachineRegistry.CallOpts, _teeId)
}
...
func (_TeeMachineRegistry *TeeMachineRegistryCaller) GetTeeMachineWithAttestationData(opts *bind.CallOpts, _teeId common.Address) (IMachineManagerTeeMachineWithAttestationData, error) {
	var out []interface{}
...
//
// Solidity: function getTeeMachineWithAttestationData(address _teeId) view returns((address,address,string,bytes32,bytes32))
func (_TeeMachineRegistry *TeeMachineRegistrySession) GetTeeMachineWithAttestationData(_teeId common.Address) (IMachineManagerTeeMachineWithAttestationData, error) {
...
//
// Solidity: function getTeeMachineWithAttestationData(address _teeId) view returns((address,address,string,bytes32,bytes32))
func (_TeeMachineRegistry *TeeMachineRegistryCallerSession) GetTeeMachineWithAttestationData(_teeId common.Address) (IMachineManagerTeeMachineWithAttestationData, error) {
	return _TeeMachineRegistry.Contract.GetTeeMachineWithAttestationData(&_TeeMachineRegistry.CallOpts, _teeId)
}
...
func (_TeeMachineRegistry *TeeMachineRegistryTransactor) Register(opts *bind.TransactOpts, _teeMachineData IMachineManagerTeeMachineData, _teeMachineDataSignature Signature, _teeProxyId common.Address, _url string, _claimBackAddress common.Address) (*types.Transaction, error) {
...
//
// Solidity: function register((uint256,address,bytes32,bytes32,(bytes32,bytes32)) _teeMachineData, (uint8,bytes32,bytes32) _teeMachineDataSignature, address _teeProxyId, string _url, address _claimBackAddress) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistrySession) Register(_teeMachineData IMachineManagerTeeMachineData, _teeMachineDataSignature Signature, _teeProxyId common.Address, _url string, _claimBackAddress common.Address) (*types.Transaction, error) {
...
//
// Solidity: function register((uint256,address,bytes32,bytes32,(bytes32,bytes32)) _teeMachineData, (uint8,bytes32,bytes32) _teeMachineDataSignature, address _teeProxyId, string _url, address _claimBackAddress) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistryTransactorSession) Register(_teeMachineData IMachineManagerTeeMachineData, _teeMachineDataSignature Signature, _teeProxyId common.Address, _url string, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeMachineRegistry.Contract.Register(&_TeeMachineRegistry.TransactOpts, _teeMachineData, _teeMachineDataSignature, _teeProxyId, _url, _claimBackAddress)
}
