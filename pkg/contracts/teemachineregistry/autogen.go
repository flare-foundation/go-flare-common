...
// PauseWithProof is a paid mutator transaction binding the contract method 0x7ebfa3e9.
//
// Solidity: function pauseWithProof(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,string,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,bytes32),(bytes,bytes32,bytes,bytes32)) _proof) returns()
...
// ToProduction is a paid mutator transaction binding the contract method 0x03649c68.
//
// Solidity: function toProduction(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,string,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,bytes32),(bytes,bytes32,bytes,bytes32)) _proof) returns()
