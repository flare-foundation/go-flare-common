...
// Register is a paid mutator transaction binding the contract method 0x2b169d07.
//
// Solidity: function register(uint256 _extensionId, (bytes32,bytes32) _teePublicKey, address _teeProxyId, string _url, bytes32 _codeHash, bytes32 _platform) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistryTransactor) Register(opts *bind.TransactOpts, _extensionId *big.Int, _teePublicKey PublicKey, _teeProxyId common.Address, _url string, _codeHash [32]byte, _platform [32]byte) (*types.Transaction, error) {
	return _TeeMachineRegistry.contract.Transact(opts, "register", _extensionId, _teePublicKey, _teeProxyId, _url, _codeHash, _platform)
}

// Register is a paid mutator transaction binding the contract method 0x2b169d07.
//
// Solidity: function register(uint256 _extensionId, (bytes32,bytes32) _teePublicKey, address _teeProxyId, string _url, bytes32 _codeHash, bytes32 _platform) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistrySession) Register(_extensionId *big.Int, _teePublicKey PublicKey, _teeProxyId common.Address, _url string, _codeHash [32]byte, _platform [32]byte) (*types.Transaction, error) {
	return _TeeMachineRegistry.Contract.Register(&_TeeMachineRegistry.TransactOpts, _extensionId, _teePublicKey, _teeProxyId, _url, _codeHash, _platform)
}

// Register is a paid mutator transaction binding the contract method 0x2b169d07.
//
// Solidity: function register(uint256 _extensionId, (bytes32,bytes32) _teePublicKey, address _teeProxyId, string _url, bytes32 _codeHash, bytes32 _platform) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistryTransactorSession) Register(_extensionId *big.Int, _teePublicKey PublicKey, _teeProxyId common.Address, _url string, _codeHash [32]byte, _platform [32]byte) (*types.Transaction, error) {
	return _TeeMachineRegistry.Contract.Register(&_TeeMachineRegistry.TransactOpts, _extensionId, _teePublicKey, _teeProxyId, _url, _codeHash, _platform)
}
