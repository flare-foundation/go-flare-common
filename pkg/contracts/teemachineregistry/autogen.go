...
// PauseWithProof is a paid mutator transaction binding the contract method 0x14e266f7.
//
// Solidity: function pauseWithProof(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,address,string,bytes32,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) _proof) returns()
...
// Register is a paid mutator transaction binding the contract method 0xd1a4c161.
//
// Solidity: function register((uint256,address,bytes32,bytes32,(bytes32,bytes32)) _teeMachineData, (uint8,bytes32,bytes32) _teeMachineDataSignature, address _teeProxyId, string _url) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistryTransactor) Register(opts *bind.TransactOpts, _teeMachineData ITeeMachineRegistryTeeMachineData, _teeMachineDataSignature Signature, _teeProxyId common.Address, _url string) (*types.Transaction, error) {
	return _TeeMachineRegistry.contract.Transact(opts, "register", _teeMachineData, _teeMachineDataSignature, _teeProxyId, _url)
}

// Register is a paid mutator transaction binding the contract method 0xd1a4c161.
//
// Solidity: function register((uint256,address,bytes32,bytes32,(bytes32,bytes32)) _teeMachineData, (uint8,bytes32,bytes32) _teeMachineDataSignature, address _teeProxyId, string _url) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistrySession) Register(_teeMachineData ITeeMachineRegistryTeeMachineData, _teeMachineDataSignature Signature, _teeProxyId common.Address, _url string) (*types.Transaction, error) {
	return _TeeMachineRegistry.Contract.Register(&_TeeMachineRegistry.TransactOpts, _teeMachineData, _teeMachineDataSignature, _teeProxyId, _url)
}

// Register is a paid mutator transaction binding the contract method 0xd1a4c161.
//
// Solidity: function register((uint256,address,bytes32,bytes32,(bytes32,bytes32)) _teeMachineData, (uint8,bytes32,bytes32) _teeMachineDataSignature, address _teeProxyId, string _url) payable returns()
func (_TeeMachineRegistry *TeeMachineRegistryTransactorSession) Register(_teeMachineData ITeeMachineRegistryTeeMachineData, _teeMachineDataSignature Signature, _teeProxyId common.Address, _url string) (*types.Transaction, error) {
	return _TeeMachineRegistry.Contract.Register(&_TeeMachineRegistry.TransactOpts, _teeMachineData, _teeMachineDataSignature, _teeProxyId, _url)
}

// Replicate is a paid mutator transaction binding the contract method 0x8b5d3713.
//
// Solidity: function replicate(address _newTeeId, ((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,address,string,bytes32,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) _proof) returns()
...
// ToProduction is a paid mutator transaction binding the contract method 0xd602b414.
//
// Solidity: function toProduction(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,address,string,bytes32,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) _proof) returns()
