...
// GetAllActiveTeeMachines is a free data retrieval call binding the contract method 0x2b9879dd.
//
// Solidity: function getAllActiveTeeMachines() view returns(address[] _teeIds, string[] _urls)
func (_TeeMachineRegistry *TeeMachineRegistryCaller) GetAllActiveTeeMachines(opts *bind.CallOpts) (struct {
	TeeIds []common.Address
	Urls   []string
}, error) {
	var out []interface{}
	err := _TeeMachineRegistry.contract.Call(opts, &out, "getAllActiveTeeMachines")
...
//
// Solidity: function getAllActiveTeeMachines() view returns(address[] _teeIds, string[] _urls)
func (_TeeMachineRegistry *TeeMachineRegistrySession) GetAllActiveTeeMachines() (struct {
	TeeIds []common.Address
	Urls   []string
}, error) {
	return _TeeMachineRegistry.Contract.GetAllActiveTeeMachines(&_TeeMachineRegistry.CallOpts)
}

// GetAllActiveTeeMachines is a free data retrieval call binding the contract method 0x2b9879dd.
//
// Solidity: function getAllActiveTeeMachines() view returns(address[] _teeIds, string[] _urls)
func (_TeeMachineRegistry *TeeMachineRegistryCallerSession) GetAllActiveTeeMachines() (struct {
	TeeIds []common.Address
	Urls   []string
}, error) {
	return _TeeMachineRegistry.Contract.GetAllActiveTeeMachines(&_TeeMachineRegistry.CallOpts)
...
// FilterTeeMachinePaused is a free log retrieval operation binding the contract event 0xe7e9e99ec2a3dae257d44dff7a2fd5cfe629b72f26a432621302b08e40561b78.
//
// Solidity: event TeeMachinePaused(address indexed teeId, bool withProof)
...
// WatchTeeMachinePaused is a free log subscription operation binding the contract event 0xe7e9e99ec2a3dae257d44dff7a2fd5cfe629b72f26a432621302b08e40561b78.
//
// Solidity: event TeeMachinePaused(address indexed teeId, bool withProof)
...
// ParseTeeMachinePaused is a log parse operation binding the contract event 0xe7e9e99ec2a3dae257d44dff7a2fd5cfe629b72f26a432621302b08e40561b78.
//
// Solidity: event TeeMachinePaused(address indexed teeId, bool withProof)
