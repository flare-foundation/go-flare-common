...
func (_TeeWalletProjectManager *TeeWalletProjectManagerTransactor) CreateProject(opts *bind.TransactOpts, _extensionId *big.Int, _keyType [32]byte, _signingAlgo [32]byte) (*types.Transaction, error) {
	return _TeeWalletProjectManager.contract.Transact(opts, "createProject", _extensionId, _keyType, _signingAlgo)
}

// CreateProject is a paid mutator transaction binding the contract method 0xa650c968.
//
// Solidity: function createProject(uint256 _extensionId, bytes32 _keyType, bytes32 _signingAlgo) returns(bytes32 _projectId)
func (_TeeWalletProjectManager *TeeWalletProjectManagerSession) CreateProject(_extensionId *big.Int, _keyType [32]byte, _signingAlgo [32]byte) (*types.Transaction, error) {
	return _TeeWalletProjectManager.Contract.CreateProject(&_TeeWalletProjectManager.TransactOpts, _extensionId, _keyType, _signingAlgo)
}

// CreateProject is a paid mutator transaction binding the contract method 0xa650c968.
//
// Solidity: function createProject(uint256 _extensionId, bytes32 _keyType, bytes32 _signingAlgo) returns(bytes32 _projectId)
func (_TeeWalletProjectManager *TeeWalletProjectManagerTransactorSession) CreateProject(_extensionId *big.Int, _keyType [32]byte, _signingAlgo [32]byte) (*types.Transaction, error) {
	return _TeeWalletProjectManager.Contract.CreateProject(&_TeeWalletProjectManager.TransactOpts, _extensionId, _keyType, _signingAlgo)
}
