...
// ITeeExtensionRegistryTeeInstructionParams is an auto generated low-level Go binding around an user-defined struct.
type ITeeExtensionRegistryTeeInstructionParams struct {
	OpType             [32]byte
	OpCommand          [32]byte
	Message            []byte
...
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) SendInstructions(opts *bind.TransactOpts, _teeIds []common.Address, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "sendInstructions", _teeIds, _instructionParams)
}

// SendInstructions is a paid mutator transaction binding the contract method 0xf731df53.
//
// Solidity: function sendInstructions(address[] _teeIds, (bytes32,bytes32,bytes,address[],uint64,address) _instructionParams) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) SendInstructions(_teeIds []common.Address, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendInstructions(&_TeeExtensionRegistry.TransactOpts, _teeIds, _instructionParams)
}

// SendInstructions is a paid mutator transaction binding the contract method 0xf731df53.
//
// Solidity: function sendInstructions(address[] _teeIds, (bytes32,bytes32,bytes,address[],uint64,address) _instructionParams) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) SendInstructions(_teeIds []common.Address, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendInstructions(&_TeeExtensionRegistry.TransactOpts, _teeIds, _instructionParams)
}
...
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) SendSystemInstructions(opts *bind.TransactOpts, _instructionId [32]byte, _teeIds []common.Address, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "sendSystemInstructions", _instructionId, _teeIds, _instructionParams)
}

// SendSystemInstructions is a paid mutator transaction binding the contract method 0x1456290e.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, address[] _teeIds, (bytes32,bytes32,bytes,address[],uint64,address) _instructionParams) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) SendSystemInstructions(_instructionId [32]byte, _teeIds []common.Address, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeIds, _instructionParams)
}

// SendSystemInstructions is a paid mutator transaction binding the contract method 0x1456290e.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, address[] _teeIds, (bytes32,bytes32,bytes,address[],uint64,address) _instructionParams) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) SendSystemInstructions(_instructionId [32]byte, _teeIds []common.Address, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeIds, _instructionParams)
}
...
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) SendSystemInstructions0(opts *bind.TransactOpts, _instructionId [32]byte, _teeMachines []ITeeMachineRegistryTeeMachine, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "sendSystemInstructions0", _instructionId, _teeMachines, _instructionParams)
}

// SendSystemInstructions0 is a paid mutator transaction binding the contract method 0x32103728.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, (address,address,string)[] _teeMachines, (bytes32,bytes32,bytes,address[],uint64,address) _instructionParams) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) SendSystemInstructions0(_instructionId [32]byte, _teeMachines []ITeeMachineRegistryTeeMachine, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions0(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeMachines, _instructionParams)
}

// SendSystemInstructions0 is a paid mutator transaction binding the contract method 0x32103728.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, (address,address,string)[] _teeMachines, (bytes32,bytes32,bytes,address[],uint64,address) _instructionParams) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) SendSystemInstructions0(_instructionId [32]byte, _teeMachines []ITeeMachineRegistryTeeMachine, _instructionParams ITeeExtensionRegistryTeeInstructionParams) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions0(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeMachines, _instructionParams)
}
