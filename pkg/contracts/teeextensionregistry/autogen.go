...
func (_TeeExtensionRegistry *TeeExtensionRegistryCaller) GetSystemInstructionsSenders(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _TeeExtensionRegistry.contract.Call(opts, &out, "getSystemInstructionsSenders")
...
//
// Solidity: function getSystemInstructionsSenders() view returns(address[])
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) GetSystemInstructionsSenders() ([]common.Address, error) {
	return _TeeExtensionRegistry.Contract.GetSystemInstructionsSenders(&_TeeExtensionRegistry.CallOpts)
}

// GetSystemInstructionsSenders is a free data retrieval call binding the contract method 0xa37768e5.
//
// Solidity: function getSystemInstructionsSenders() view returns(address[])
func (_TeeExtensionRegistry *TeeExtensionRegistryCallerSession) GetSystemInstructionsSenders() ([]common.Address, error) {
	return _TeeExtensionRegistry.Contract.GetSystemInstructionsSenders(&_TeeExtensionRegistry.CallOpts)
}
...
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) RegisterSystemInstructionsSenders(opts *bind.TransactOpts, _instructionsSenders []common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "registerSystemInstructionsSenders", _instructionsSenders)
}

// RegisterSystemInstructionsSenders is a paid mutator transaction binding the contract method 0x4d9003cf.
//
// Solidity: function registerSystemInstructionsSenders(address[] _instructionsSenders) returns()
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) RegisterSystemInstructionsSenders(_instructionsSenders []common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.RegisterSystemInstructionsSenders(&_TeeExtensionRegistry.TransactOpts, _instructionsSenders)
}

// RegisterSystemInstructionsSenders is a paid mutator transaction binding the contract method 0x4d9003cf.
//
// Solidity: function registerSystemInstructionsSenders(address[] _instructionsSenders) returns()
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) RegisterSystemInstructionsSenders(_instructionsSenders []common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.RegisterSystemInstructionsSenders(&_TeeExtensionRegistry.TransactOpts, _instructionsSenders)
}
...
// SendInstructions is a paid mutator transaction binding the contract method 0xfc410af3.
//
// Solidity: function sendInstructions(address[] _teeIds, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) SendInstructions(opts *bind.TransactOpts, _teeIds []common.Address, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "sendInstructions", _teeIds, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendInstructions is a paid mutator transaction binding the contract method 0xfc410af3.
//
// Solidity: function sendInstructions(address[] _teeIds, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) SendInstructions(_teeIds []common.Address, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendInstructions(&_TeeExtensionRegistry.TransactOpts, _teeIds, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendInstructions is a paid mutator transaction binding the contract method 0xfc410af3.
//
// Solidity: function sendInstructions(address[] _teeIds, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) SendInstructions(_teeIds []common.Address, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendInstructions(&_TeeExtensionRegistry.TransactOpts, _teeIds, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendSystemInstructions is a paid mutator transaction binding the contract method 0x05d28ec8.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, (address,address,string)[] _teeMachines, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) SendSystemInstructions(opts *bind.TransactOpts, _instructionId [32]byte, _teeMachines []ITeeMachineRegistryTeeMachine, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "sendSystemInstructions", _instructionId, _teeMachines, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendSystemInstructions is a paid mutator transaction binding the contract method 0x05d28ec8.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, (address,address,string)[] _teeMachines, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) SendSystemInstructions(_instructionId [32]byte, _teeMachines []ITeeMachineRegistryTeeMachine, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeMachines, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendSystemInstructions is a paid mutator transaction binding the contract method 0x05d28ec8.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, (address,address,string)[] _teeMachines, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) SendSystemInstructions(_instructionId [32]byte, _teeMachines []ITeeMachineRegistryTeeMachine, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeMachines, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendSystemInstructions0 is a paid mutator transaction binding the contract method 0xe9318873.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, address[] _teeIds, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) SendSystemInstructions0(opts *bind.TransactOpts, _instructionId [32]byte, _teeIds []common.Address, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "sendSystemInstructions0", _instructionId, _teeIds, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendSystemInstructions0 is a paid mutator transaction binding the contract method 0xe9318873.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, address[] _teeIds, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) SendSystemInstructions0(_instructionId [32]byte, _teeIds []common.Address, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions0(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeIds, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}

// SendSystemInstructions0 is a paid mutator transaction binding the contract method 0xe9318873.
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, address[] _teeIds, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold, address _claimBackAddress) payable returns(bytes32)
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) SendSystemInstructions0(_instructionId [32]byte, _teeIds []common.Address, _opType [32]byte, _opCommand [32]byte, _message []byte, _cosigners []common.Address, _cosignersThreshold uint64, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.SendSystemInstructions0(&_TeeExtensionRegistry.TransactOpts, _instructionId, _teeIds, _opType, _opCommand, _message, _cosigners, _cosignersThreshold, _claimBackAddress)
}
...
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactor) UnregisterSystemInstructionsSenders(opts *bind.TransactOpts, _instructionsSenders []common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.contract.Transact(opts, "unregisterSystemInstructionsSenders", _instructionsSenders)
}

// UnregisterSystemInstructionsSenders is a paid mutator transaction binding the contract method 0xf123abf3.
//
// Solidity: function unregisterSystemInstructionsSenders(address[] _instructionsSenders) returns()
func (_TeeExtensionRegistry *TeeExtensionRegistrySession) UnregisterSystemInstructionsSenders(_instructionsSenders []common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.UnregisterSystemInstructionsSenders(&_TeeExtensionRegistry.TransactOpts, _instructionsSenders)
}

// UnregisterSystemInstructionsSenders is a paid mutator transaction binding the contract method 0xf123abf3.
//
// Solidity: function unregisterSystemInstructionsSenders(address[] _instructionsSenders) returns()
func (_TeeExtensionRegistry *TeeExtensionRegistryTransactorSession) UnregisterSystemInstructionsSenders(_instructionsSenders []common.Address) (*types.Transaction, error) {
	return _TeeExtensionRegistry.Contract.UnregisterSystemInstructionsSenders(&_TeeExtensionRegistry.TransactOpts, _instructionsSenders)
}
