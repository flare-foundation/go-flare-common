...
//
// Solidity: function sendSystemInstructions(bytes32 _instructionId, (address,address,string)[] _teeMachines, bytes32 _opType, bytes32 _opCommand, bytes _message, address[] _cosigners, uint64 _cosignersThreshold) payable returns()
