...
func (_TeePayment *TeePaymentTransactor) Pay(opts *bind.TransactOpts, _account ITeePaymentsPMWMultisigAccount, _paymentInstruction ITeePaymentsPaymentInstruction, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePayment.contract.Transact(opts, "pay", _account, _paymentInstruction, _claimBackAddress)
}

// Pay is a paid mutator transaction binding the contract method 0x009ce938.
//
// Solidity: function pay((bytes32,string) _account, (string,bytes,uint256,uint256,bytes32) _paymentInstruction, address _claimBackAddress) payable returns(uint64 _nonce, uint64 _subNonce)
func (_TeePayment *TeePaymentSession) Pay(_account ITeePaymentsPMWMultisigAccount, _paymentInstruction ITeePaymentsPaymentInstruction, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePayment.Contract.Pay(&_TeePayment.TransactOpts, _account, _paymentInstruction, _claimBackAddress)
}

// Pay is a paid mutator transaction binding the contract method 0x009ce938.
//
// Solidity: function pay((bytes32,string) _account, (string,bytes,uint256,uint256,bytes32) _paymentInstruction, address _claimBackAddress) payable returns(uint64 _nonce, uint64 _subNonce)
func (_TeePayment *TeePaymentTransactorSession) Pay(_account ITeePaymentsPMWMultisigAccount, _paymentInstruction ITeePaymentsPaymentInstruction, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePayment.Contract.Pay(&_TeePayment.TransactOpts, _account, _paymentInstruction, _claimBackAddress)
}
...
func (_TeePayment *TeePaymentTransactor) Reissue(opts *bind.TransactOpts, _account ITeePaymentsPMWMultisigAccount, _nonce uint64, _firstSubNonce uint64, _paymentInstructions []ITeePaymentsPaymentInstruction, _reissueFeeParams ITeePaymentsReissueFeeParams, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePayment.contract.Transact(opts, "reissue", _account, _nonce, _firstSubNonce, _paymentInstructions, _reissueFeeParams, _claimBackAddress)
}

// Reissue is a paid mutator transaction binding the contract method 0xb250c225.
//
// Solidity: function reissue((bytes32,string) _account, uint64 _nonce, uint64 _firstSubNonce, (string,bytes,uint256,uint256,bytes32)[] _paymentInstructions, (uint256[],int16[][],uint16[]) _reissueFeeParams, address _claimBackAddress) payable returns()
func (_TeePayment *TeePaymentSession) Reissue(_account ITeePaymentsPMWMultisigAccount, _nonce uint64, _firstSubNonce uint64, _paymentInstructions []ITeePaymentsPaymentInstruction, _reissueFeeParams ITeePaymentsReissueFeeParams, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePayment.Contract.Reissue(&_TeePayment.TransactOpts, _account, _nonce, _firstSubNonce, _paymentInstructions, _reissueFeeParams, _claimBackAddress)
}

// Reissue is a paid mutator transaction binding the contract method 0xb250c225.
//
// Solidity: function reissue((bytes32,string) _account, uint64 _nonce, uint64 _firstSubNonce, (string,bytes,uint256,uint256,bytes32)[] _paymentInstructions, (uint256[],int16[][],uint16[]) _reissueFeeParams, address _claimBackAddress) payable returns()
func (_TeePayment *TeePaymentTransactorSession) Reissue(_account ITeePaymentsPMWMultisigAccount, _nonce uint64, _firstSubNonce uint64, _paymentInstructions []ITeePaymentsPaymentInstruction, _reissueFeeParams ITeePaymentsReissueFeeParams, _claimBackAddress common.Address) (*types.Transaction, error) {
	return _TeePayment.Contract.Reissue(&_TeePayment.TransactOpts, _account, _nonce, _firstSubNonce, _paymentInstructions, _reissueFeeParams, _claimBackAddress)
}
