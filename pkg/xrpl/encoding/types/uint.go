...
func (*UInt8) ToJSON(b *bytes.Buffer, _ int) (any, error) {
	u, err := b.ReadByte()
	if err != nil {
		return nil, fmt.Errorf("reading uint8 from buffer: %w", err)
	}
	return u, nil
}
...
func (*UInt16) ToJSON(b *bytes.Buffer, _ int) (any, error) {
	...
	n, err := b.Read(v)
	if err != nil {
		return nil, fmt.Errorf("reading uint16 from buffer: %w", err)
	}
	if n != l {
...
func (*UInt32) ToJSON(b *bytes.Buffer, _ int) (any, error) {
	...
	n, err := b.Read(v)
	if err != nil {
		return nil, fmt.Errorf("reading uint32 from buffer: %w", err)
	}
	if n != l {
...
func (*UInt64) ToJSON(b *bytes.Buffer, _ int) (any, error) {
	...
	n, err := b.Read(v)
	if err != nil {
		return nil, fmt.Errorf("reading uint64 from buffer: %w", err)
	}
	if n != l {
