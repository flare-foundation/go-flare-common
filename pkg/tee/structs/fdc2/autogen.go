...
// IBtcPaymentProof is an auto generated low-level Go binding around an user-defined struct.
type IBtcPaymentProof struct {
	Signatures   IFdc2VerificationFdc2Signatures
	Header       IFdc2HubFdc2ResponseHeader
	RequestBody  IBtcPaymentRequestBody
	ResponseBody IBtcPaymentResponseBody
}

// IBtcPaymentRequestBody is an auto generated low-level Go binding around an user-defined struct.
type IBtcPaymentRequestBody struct {
	TransactionId    [32]byte
...
// IBtcPaymentResponseBody is an auto generated low-level Go binding around an user-defined struct.
type IBtcPaymentResponseBody struct {
	Status               uint8
	TransactionId        [32]byte
	SourceAddress        string
	...
	ReceivedAmountSats   *big.Int
	SpentAmountSats      *big.Int
	BlockNumber          uint64
	BlockTimestamp       uint64
	Confirmations        uint64
}
...
// BtcDepositProofStruct is a paid mutator transaction binding the contract method 0x8e0d8b1e.
//
// Solidity: function btcDepositProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,uint32,uint32,bytes32,uint16,uint16),(uint8,string,bytes32,uint256,bytes32,uint64,uint64,uint64,bytes)) ) returns()
...
// BtcDepositRequestBodyStruct is a paid mutator transaction binding the contract method 0xd5e34aaf.
//
// Solidity: function btcDepositRequestBodyStruct((bytes32,uint32,uint32,bytes32,uint16,uint16) ) returns()
...
// BtcDepositResponseBodyStruct is a paid mutator transaction binding the contract method 0xc7348485.
//
// Solidity: function btcDepositResponseBodyStruct((uint8,string,bytes32,uint256,bytes32,uint64,uint64,uint64,bytes) ) returns()
...
// BtcPaymentProofStruct is a paid mutator transaction binding the contract method 0xa40be0bb.
//
// Solidity: function btcPaymentProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,string,string,uint16),(uint8,bytes32,string,bytes32,string,bytes32,bytes32,uint256,uint256,uint64,uint64,uint64)) ) returns()
func (_Fdc2 *Fdc2Transactor) BtcPaymentProofStruct(opts *bind.TransactOpts, arg0 IBtcPaymentProof) (*types.Transaction, error) {
	return _Fdc2.contract.Transact(opts, "btcPaymentProofStruct", arg0)
}

// BtcPaymentProofStruct is a paid mutator transaction binding the contract method 0xa40be0bb.
//
// Solidity: function btcPaymentProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,string,string,uint16),(uint8,bytes32,string,bytes32,string,bytes32,bytes32,uint256,uint256,uint64,uint64,uint64)) ) returns()
func (_Fdc2 *Fdc2Session) BtcPaymentProofStruct(arg0 IBtcPaymentProof) (*types.Transaction, error) {
	return _Fdc2.Contract.BtcPaymentProofStruct(&_Fdc2.TransactOpts, arg0)
}

// BtcPaymentProofStruct is a paid mutator transaction binding the contract method 0xa40be0bb.
//
// Solidity: function btcPaymentProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,string,string,uint16),(uint8,bytes32,string,bytes32,string,bytes32,bytes32,uint256,uint256,uint64,uint64,uint64)) ) returns()
func (_Fdc2 *Fdc2TransactorSession) BtcPaymentProofStruct(arg0 IBtcPaymentProof) (*types.Transaction, error) {
	return _Fdc2.Contract.BtcPaymentProofStruct(&_Fdc2.TransactOpts, arg0)
}

// BtcPaymentRequestBodyStruct is a paid mutator transaction binding the contract method 0xb7bbae04.
//
// Solidity: function btcPaymentRequestBodyStruct((bytes32,string,string,uint16) ) returns()
func (_Fdc2 *Fdc2Transactor) BtcPaymentRequestBodyStruct(opts *bind.TransactOpts, arg0 IBtcPaymentRequestBody) (*types.Transaction, error) {
	return _Fdc2.contract.Transact(opts, "btcPaymentRequestBodyStruct", arg0)
}

// BtcPaymentRequestBodyStruct is a paid mutator transaction binding the contract method 0xb7bbae04.
//
// Solidity: function btcPaymentRequestBodyStruct((bytes32,string,string,uint16) ) returns()
func (_Fdc2 *Fdc2Session) BtcPaymentRequestBodyStruct(arg0 IBtcPaymentRequestBody) (*types.Transaction, error) {
	return _Fdc2.Contract.BtcPaymentRequestBodyStruct(&_Fdc2.TransactOpts, arg0)
}

// BtcPaymentRequestBodyStruct is a paid mutator transaction binding the contract method 0xb7bbae04.
//
// Solidity: function btcPaymentRequestBodyStruct((bytes32,string,string,uint16) ) returns()
func (_Fdc2 *Fdc2TransactorSession) BtcPaymentRequestBodyStruct(arg0 IBtcPaymentRequestBody) (*types.Transaction, error) {
	return _Fdc2.Contract.BtcPaymentRequestBodyStruct(&_Fdc2.TransactOpts, arg0)
}

// BtcPaymentResponseBodyStruct is a paid mutator transaction binding the contract method 0x8c096ce5.
//
// Solidity: function btcPaymentResponseBodyStruct((uint8,bytes32,string,bytes32,string,bytes32,bytes32,uint256,uint256,uint64,uint64,uint64) ) returns()
func (_Fdc2 *Fdc2Transactor) BtcPaymentResponseBodyStruct(opts *bind.TransactOpts, arg0 IBtcPaymentResponseBody) (*types.Transaction, error) {
	return _Fdc2.contract.Transact(opts, "btcPaymentResponseBodyStruct", arg0)
}

// BtcPaymentResponseBodyStruct is a paid mutator transaction binding the contract method 0x8c096ce5.
//
// Solidity: function btcPaymentResponseBodyStruct((uint8,bytes32,string,bytes32,string,bytes32,bytes32,uint256,uint256,uint64,uint64,uint64) ) returns()
func (_Fdc2 *Fdc2Session) BtcPaymentResponseBodyStruct(arg0 IBtcPaymentResponseBody) (*types.Transaction, error) {
	return _Fdc2.Contract.BtcPaymentResponseBodyStruct(&_Fdc2.TransactOpts, arg0)
}

// BtcPaymentResponseBodyStruct is a paid mutator transaction binding the contract method 0x8c096ce5.
//
// Solidity: function btcPaymentResponseBodyStruct((uint8,bytes32,string,bytes32,string,bytes32,bytes32,uint256,uint256,uint64,uint64,uint64) ) returns()
func (_Fdc2 *Fdc2TransactorSession) BtcPaymentResponseBodyStruct(arg0 IBtcPaymentResponseBody) (*types.Transaction, error) {
	return _Fdc2.Contract.BtcPaymentResponseBodyStruct(&_Fdc2.TransactOpts, arg0)
}
