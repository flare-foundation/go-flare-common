...
// PmwMultisigUtxoConfiguredProofStruct is a paid mutator transaction binding the contract method 0x81815bf3.
//
// Solidity: function pmwMultisigUtxoConfiguredProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(uint32,bytes[],uint64,(bytes32,uint32)[]),(uint8,string,string[])) ) returns()
...
// PmwMultisigUtxoConfiguredResponseBodyStruct is a paid mutator transaction binding the contract method 0xc3b72015.
//
// Solidity: function pmwMultisigUtxoConfiguredResponseBodyStruct((uint8,string,string[]) ) returns()
