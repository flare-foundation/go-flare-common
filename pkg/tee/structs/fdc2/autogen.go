...
// PmwUtxoProposalCheckProofStruct is a paid mutator transaction binding the contract method 0x06e21e18.
//
// Solidity: function pmwUtxoProposalCheckProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,uint32,uint64,uint32,uint64,bytes32),(address,uint32,uint64,bytes32,bytes32,uint32,uint64,uint32)) ) returns()
