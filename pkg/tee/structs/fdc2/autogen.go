...
// PmwUtxoProposalCheckProofStruct is a paid mutator transaction binding the contract method 0xdc100b7d.
//
// Solidity: function pmwUtxoProposalCheckProofStruct((bytes32[],(bytes32,bytes32,uint64,uint64,(bytes32,uint32,uint64,uint32,uint64,bytes32),(address,uint32,uint64,bytes32,bytes32,uint32,uint64))) ) returns()
...
// PmwUtxoProposalCheckResponseBodyStruct is a paid mutator transaction binding the contract method 0xce9cd48f.
//
// Solidity: function pmwUtxoProposalCheckResponseBodyStruct((address,uint32,uint64,bytes32,bytes32,uint32,uint64) ) returns()
