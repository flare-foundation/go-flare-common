...
// BtcDepositProofStruct is a paid mutator transaction binding the contract method 0x418315d4.
//
// Solidity: function btcDepositProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,uint32,uint32,bytes32,uint16,uint16),(uint8,string,bytes32,uint256,bytes32,uint64,uint64,uint64)) ) returns()
...
// BtcDepositResponseBodyStruct is a paid mutator transaction binding the contract method 0xd18d418c.
//
// Solidity: function btcDepositResponseBodyStruct((uint8,string,bytes32,uint256,bytes32,uint64,uint64,uint64) ) returns()
