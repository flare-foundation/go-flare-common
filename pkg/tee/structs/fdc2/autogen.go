...
// AvailabilityCheckProofStruct is a paid mutator transaction binding the contract method 0x776889eb.
//
// Solidity: function availabilityCheckProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(uint256,bytes32,bytes32,uint16,address,address[],uint64,uint64),(address,address,string,bytes32,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) ) returns()
...
// Fdc2ResponseHeaderStruct is a paid mutator transaction binding the contract method 0x92000221.
//
// Solidity: function fdc2ResponseHeaderStruct((uint256,bytes32,bytes32,uint16,address,address[],uint64,uint64) ) returns()
...
// PmwFeeProofProofStruct is a paid mutator transaction binding the contract method 0x04443328.
//
// Solidity: function pmwFeeProofProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(uint256,bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,string,uint64,uint64,uint64),(uint256,uint256)) ) returns()
...
// PmwMultisigAccountConfiguredProofStruct is a paid mutator transaction binding the contract method 0xb9ca5782.
//
// Solidity: function pmwMultisigAccountConfiguredProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(uint256,bytes32,bytes32,uint16,address,address[],uint64,uint64),(string,bytes[],uint64),(uint8,uint64)) ) returns()
...
// PmwPaymentStatusProofStruct is a paid mutator transaction binding the contract method 0x605f5596.
//
// Solidity: function pmwPaymentStatusProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(uint256,bytes32,bytes32,uint16,address,address[],uint64,uint64),(bytes32,string,uint64,uint64),(string,bytes,uint256,uint256,bytes32,uint8,string,uint256,uint256,bytes32,uint64,uint64)) ) returns()
