...
// BatchRecordStruct is a paid mutator transaction binding the contract method 0x953d4a09.
//
// Solidity: function batchRecordStruct((uint64,uint64,uint64,uint32,uint24) ) returns()
func (_TeePayments *TeePaymentsTransactor) BatchRecordStruct(opts *bind.TransactOpts, arg0 ITeePaymentsUtxoBatchRecord) (*types.Transaction, error) {
	return _TeePayments.contract.Transact(opts, "batchRecordStruct", arg0)
}

// BatchRecordStruct is a paid mutator transaction binding the contract method 0x953d4a09.
//
// Solidity: function batchRecordStruct((uint64,uint64,uint64,uint32,uint24) ) returns()
func (_TeePayments *TeePaymentsSession) BatchRecordStruct(arg0 ITeePaymentsUtxoBatchRecord) (*types.Transaction, error) {
	return _TeePayments.Contract.BatchRecordStruct(&_TeePayments.TransactOpts, arg0)
}

// BatchRecordStruct is a paid mutator transaction binding the contract method 0x953d4a09.
//
// Solidity: function batchRecordStruct((uint64,uint64,uint64,uint32,uint24) ) returns()
func (_TeePayments *TeePaymentsTransactorSession) BatchRecordStruct(arg0 ITeePaymentsUtxoBatchRecord) (*types.Transaction, error) {
	return _TeePayments.Contract.BatchRecordStruct(&_TeePayments.TransactOpts, arg0)
}
...
// UtxoPaymentInstructionMessageStruct is a paid mutator transaction binding the contract method 0x6f24c8f1.
//
// Solidity: function utxoPaymentInstructionMessageStruct((bytes32,bytes32,string,uint32,uint32,string,bytes,uint256,uint256,bytes,bytes32,uint64,uint64,uint64,uint64) ) returns()
