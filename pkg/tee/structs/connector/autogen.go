...
// AvailabilityCheckProofStruct is a paid mutator transaction binding the contract method 0xa1596bb1.
//
// Solidity: function availabilityCheckProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,string,uint256),(uint8,uint64,bytes32,bytes32,uint24,uint24,bytes32),bytes) ) returns()
...
// AvailabilityCheckResponseBodyStruct is a paid mutator transaction binding the contract method 0x954b6b88.
//
// Solidity: function availabilityCheckResponseBodyStruct((uint8,uint64,bytes32,bytes32,uint24,uint24,bytes32) ) returns()
