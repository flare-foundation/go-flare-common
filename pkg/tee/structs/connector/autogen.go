...
// AvailabilityCheckProofStruct is a paid mutator transaction binding the contract method 0x350678d2.
//
// Solidity: function availabilityCheckProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,string,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,bytes32),bytes) ) returns()
...
// AvailabilityCheckResponseBodyStruct is a paid mutator transaction binding the contract method 0xf74bc3d1.
//
// Solidity: function availabilityCheckResponseBodyStruct((uint8,uint64,bytes32,bytes32,uint32,uint32,bytes32) ) returns()
