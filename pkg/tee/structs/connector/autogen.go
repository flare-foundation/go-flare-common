...
// FtdcAttestationRequestStruct is a paid mutator transaction binding the contract method 0xa67d92e5.
//
// Solidity: function ftdcAttestationRequestStruct(((bytes32,bytes32,uint16,address),bytes) ) returns()
...
// FtdcRequestHeaderStruct is a paid mutator transaction binding the contract method 0xb1ff10da.
//
// Solidity: function ftdcRequestHeaderStruct((bytes32,bytes32,uint16,address) ) returns()
...
// FtdcResponseHeaderStruct is a paid mutator transaction binding the contract method 0xc59c798c.
//
// Solidity: function ftdcResponseHeaderStruct((bytes32,bytes32,uint16,address,address[],uint64,uint64) ) returns()
