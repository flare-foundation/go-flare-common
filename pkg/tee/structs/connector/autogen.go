...
// AvailabilityCheckProofStruct is a paid mutator transaction binding the contract method 0x6006c9a3.
//
// Solidity: function availabilityCheckProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(address,address,string,bytes32),(uint8,uint64,bytes32,bytes32,uint32,uint32,(bytes,bytes32,bytes,bytes32))) ) returns()
...
// AvailabilityCheckRequestBodyStruct is a paid mutator transaction binding the contract method 0x7626e235.
//
// Solidity: function availabilityCheckRequestBodyStruct((address,address,string,bytes32) ) returns()
...
// FtdcAttestationRequestStruct is a paid mutator transaction binding the contract method 0x8fc5ef47.
//
// Solidity: function ftdcAttestationRequestStruct(((bytes32,bytes32,uint16),bytes) ) returns()
...
// FtdcRequestHeaderStruct is a paid mutator transaction binding the contract method 0x9f748419.
//
// Solidity: function ftdcRequestHeaderStruct((bytes32,bytes32,uint16) ) returns()
...
// PmwMultisigAccountConfiguredProofStruct is a paid mutator transaction binding the contract method 0x63503d0a.
//
// Solidity: function pmwMultisigAccountConfiguredProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(string,bytes[],uint64),(uint8,uint64)) ) returns()
...
// PmwPaymentStatusProofStruct is a paid mutator transaction binding the contract method 0x74a8f7ca.
//
// Solidity: function pmwPaymentStatusProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(bytes32,string,uint64,uint64),(string,bytes32,uint256,uint256,bytes32,uint8,string,uint256,uint256,bytes32,uint64,uint64)) ) returns()
...
// PmwPaymentStatusResponseBodyStruct is a paid mutator transaction binding the contract method 0xe8293501.
//
// Solidity: function pmwPaymentStatusResponseBodyStruct((string,bytes32,uint256,uint256,bytes32,uint8,string,uint256,uint256,bytes32,uint64,uint64) ) returns()
