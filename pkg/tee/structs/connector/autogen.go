...
// PmwPaymentStatusProofStruct is a paid mutator transaction binding the contract method 0xb2fa68d6.
//
// Solidity: function pmwPaymentStatusProofStruct(((bytes,(uint8,bytes32,bytes32)[],(uint8,bytes32,bytes32)[]),(bytes32,bytes32,uint16,address[],uint64,uint64),(bytes32,string,uint64,uint64),(string,bytes,uint256,uint256,bytes32,uint8,string,uint256,uint256,bytes32,uint64,uint64)) ) returns()
