...
func (_Vrf *VrfTransactor) VrfInstructionMessageStruct(opts *bind.TransactOpts, arg0 IVrfVrfInstructionMessage) (*types.Transaction, error) {
...
//
// Solidity: function vrfInstructionMessageStruct((bytes32,uint64,bytes) ) returns()
func (_Vrf *VrfSession) VrfInstructionMessageStruct(arg0 IVrfVrfInstructionMessage) (*types.Transaction, error) {
...
//
// Solidity: function vrfInstructionMessageStruct((bytes32,uint64,bytes) ) returns()
func (_Vrf *VrfTransactorSession) VrfInstructionMessageStruct(arg0 IVrfVrfInstructionMessage) (*types.Transaction, error) {
	return _Vrf.Contract.VrfInstructionMessageStruct(&_Vrf.TransactOpts, arg0)
}
