...
// TeeMachineDataStruct is a paid mutator transaction binding the contract method 0xa8332a77.
//
// Solidity: function teeMachineDataStruct((uint256,address,bytes32,bytes32,(bytes32,bytes32),bytes32) ) returns()
