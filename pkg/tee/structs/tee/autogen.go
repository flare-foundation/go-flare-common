...
// InstructionStruct is a paid mutator transaction binding the contract method 0xc4ce06f9.
//
// Solidity: function instructionStruct((uint256,bytes32,address,uint64,uint32,bytes32,bytes32,address[],uint64,bytes,bytes) ) returns()
