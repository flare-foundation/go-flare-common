...
// KeyDataProviderRestoreStruct is a paid mutator transaction binding the contract method 0x113d6de2.
//
// Solidity: function keyDataProviderRestoreStruct(((bytes32,bytes32),(address,bytes32,uint64,bytes32,bytes32,bytes,uint24,uint256),string,uint256) ) returns()
