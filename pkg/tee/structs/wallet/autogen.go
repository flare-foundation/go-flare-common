...
// IWalletBackupManagerKeyDirectBackup is an auto generated low-level Go binding around an user-defined struct.
type IWalletBackupManagerKeyDirectBackup struct {
	SourceTeeId             common.Address
	WalletId                [32]byte
	KeyId                   uint64
	DestinationTeePublicKey PublicKey
	MachinePathListNonce    *big.Int
}

// IWalletBackupManagerKeyDirectRestore is an auto generated low-level Go binding around an user-defined struct.
type IWalletBackupManagerKeyDirectRestore struct {
	SourceTeeId          common.Address
...
// KeyDirectBackupStruct is a paid mutator transaction binding the contract method 0x0332a173.
//
// Solidity: function keyDirectBackupStruct((address,bytes32,uint64,(bytes32,bytes32),uint256) ) returns()
func (_TeeWallet *TeeWalletTransactor) KeyDirectBackupStruct(opts *bind.TransactOpts, arg0 IWalletBackupManagerKeyDirectBackup) (*types.Transaction, error) {
	return _TeeWallet.contract.Transact(opts, "keyDirectBackupStruct", arg0)
}

// KeyDirectBackupStruct is a paid mutator transaction binding the contract method 0x0332a173.
//
// Solidity: function keyDirectBackupStruct((address,bytes32,uint64,(bytes32,bytes32),uint256) ) returns()
func (_TeeWallet *TeeWalletSession) KeyDirectBackupStruct(arg0 IWalletBackupManagerKeyDirectBackup) (*types.Transaction, error) {
	return _TeeWallet.Contract.KeyDirectBackupStruct(&_TeeWallet.TransactOpts, arg0)
}

// KeyDirectBackupStruct is a paid mutator transaction binding the contract method 0x0332a173.
//
// Solidity: function keyDirectBackupStruct((address,bytes32,uint64,(bytes32,bytes32),uint256) ) returns()
func (_TeeWallet *TeeWalletTransactorSession) KeyDirectBackupStruct(arg0 IWalletBackupManagerKeyDirectBackup) (*types.Transaction, error) {
	return _TeeWallet.Contract.KeyDirectBackupStruct(&_TeeWallet.TransactOpts, arg0)
}

// KeyDirectRestoreStruct is a paid mutator transaction binding the contract method 0xf2ea556c.
//
// Solidity: function keyDirectRestoreStruct((address,string,(address,bytes32,uint64,bytes32,bytes32,bytes,uint32,bytes32),bytes32,uint256,uint256) ) returns()
func (_TeeWallet *TeeWalletTransactor) KeyDirectRestoreStruct(opts *bind.TransactOpts, arg0 IWalletBackupManagerKeyDirectRestore) (*types.Transaction, error) {
	return _TeeWallet.contract.Transact(opts, "keyDirectRestoreStruct", arg0)
}

// KeyDirectRestoreStruct is a paid mutator transaction binding the contract method 0xf2ea556c.
//
// Solidity: function keyDirectRestoreStruct((address,string,(address,bytes32,uint64,bytes32,bytes32,bytes,uint32,bytes32),bytes32,uint256,uint256) ) returns()
func (_TeeWallet *TeeWalletSession) KeyDirectRestoreStruct(arg0 IWalletBackupManagerKeyDirectRestore) (*types.Transaction, error) {
	return _TeeWallet.Contract.KeyDirectRestoreStruct(&_TeeWallet.TransactOpts, arg0)
}

// KeyDirectRestoreStruct is a paid mutator transaction binding the contract method 0xf2ea556c.
//
// Solidity: function keyDirectRestoreStruct((address,string,(address,bytes32,uint64,bytes32,bytes32,bytes,uint32,bytes32),bytes32,uint256,uint256) ) returns()
func (_TeeWallet *TeeWalletTransactorSession) KeyDirectRestoreStruct(arg0 IWalletBackupManagerKeyDirectRestore) (*types.Transaction, error) {
	return _TeeWallet.Contract.KeyDirectRestoreStruct(&_TeeWallet.TransactOpts, arg0)
}
